...
namespace XStorage
{
    internal static class Extensions
    {
        ...
        {
            return container.GetZDO().GetString(XConfig.Key_ContainerName, string.Empty);
        }

        internal static string GetXStorageNameOrDefault(this Container container)
        {
            return container.GetZDO().GetString(XConfig.Key_ContainerName, Localization.instance.Localize(container.m_name));
        }
